...
# S3 Gateway endpoint - keeps all data-lake traffic off the public internet
...
# Interface endpoints for services the data platform talks to privately
resource "aws_vpc_endpoint" "interface" {
  for_each            = toset(["glue", "kms", "secretsmanager", "sts"])
  vpc_id              = aws_vpc.this.id
